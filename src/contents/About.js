...
class About extends Component {
    render() {
        return (
            ...
            C V RAMAN GLOBAL UNIVERSITY.  Web development and Android development is my center of interest, i always
            love the idea of cross-platform development, 1-n one code base deploy into almost
            any platform, which web technology like Javascript , java enables me to do. I also like
